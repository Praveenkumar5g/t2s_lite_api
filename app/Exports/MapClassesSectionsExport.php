...
class MapClassesSectionsExport implements FromCollection,WithHeadings,WithEvents
{
    protected  $selects;
    protected  $row_count;
    ...
    {
        $division_name=AcademicDivisions::pluck('division_name')->toArray();
        ...
        $selects=[  //selects should have column_name and options
            ['columns_name'=>'A','options'=>$division_name],
            ['columns_name'=>'B','options'=>$classes],
            ['columns_name'=>'C','options'=>$sections],
        ];
