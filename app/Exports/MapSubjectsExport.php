...
class MapSubjectsExport implements FromCollection,WithHeadings,WithEvents
{
    protected  $selects;
    protected  $row_count;
    ...
    {
        $divisions=AcademicDivisions::pluck('division_name')->toArray();
        ...
        $selects=[  //selects should have column_name and options
            ['columns_name'=>'A','options'=>$divisions],
            ['columns_name'=>'B','options'=>$subjects],
            ['columns_name'=>'C','options'=>$classes],
            ['columns_name'=>'D','options'=>$sections],
        ];
